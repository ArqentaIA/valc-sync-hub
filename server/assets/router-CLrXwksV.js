...
const appCss = "/valc-sync-hub/assets/styles-CwMmFiEl.css";
...
const $$splitComponentImporter = () => import("./index-DOh2zTCu.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Carga, procesamiento y consolidación automática de archivos Excel con resumen agrupado."
    }]
  })
});
