...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Cx7mngGE.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CLrXwksV.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "valc-sync-hub";
var SERVER_FN_BASE = "/valc-sync-hub/_serverFn/";
